...
function Members() {
  ...
  useEffect(() => {
    ...
    // const buttons = document.querySelectorAll('.members-btn button');
    ...
    //     buttons.forEach(btn => btn.classList.remove("active-member"));
    //     button.classList.add('active-member');
    //   });
    // });
  ...
  return (
    <>
      <div className="buttons button-team">
        <button className={showtab === 1 ? "btn-container active" : "btn-container"} onClick={() => handletab(1)} >
          Social Media Team
        </button>
        <button className={showtab === 2 ? "btn-container active" : "btn-container"} onClick={() => handletab(2)} >
          Tech Team
        </button>
        <button className={showtab === 3 ? "btn-container active" : "btn-container"} onClick={() => handletab(3)}>
         PR Team
        </button>
        <button className={showtab === 4 ? "btn-container active" : "btn-container"} onClick={() => handletab(4)}>
          Board Member
        </button>
        <button className={showtab === 5 ? "btn-container active" : "btn-container"} onClick={() => handletab(5)}>
           Designing Team
        </button>
        <button className={showtab === 6 ? "btn-container active" : "btn-container"} onClick={() => handletab(6)}>
           Photography Team
        </button>
        <button className={showtab === 7 ? "btn-container active" : "btn-container"} onClick={() => handletab(7)}>
           Content Team  
        </button>
        <button className={showtab === 8 ? "btn-container active" : "btn-container"} onClick={() => handletab(8)}>
           Management Team
        </button>
      </div>
      <div className='team-members-div'>
        <div className={showtab === 1 ? "wrapper active-member" : "wrapper"} >
          {/* CTA Wrapper */}
      ...
      {/* second */}
      <div className='team-members-div'>
        <div className={showtab === 2 ? "wrapper active-member" : "wrapper"} >
          {/* CTA Wrapper */}
          <div className="intro-wrapper">
            <div className="team-title">TECH TEAM</div>
          </div>
          {/* Team Wrapper */}
          <div className="team-wrapper">
            <div className="members">
         ...
         {/* third */}
      <div className='team-members-div'>
        <div className={showtab === 3 ? "wrapper active-member" : "wrapper"} >
          {/* CTA Wrapper */}
          <div className="intro-wrapper">
            <div className="team-title">SOCIAL TEAM</div>
          </div>
          {/* Team Wrapper */}
          <div className="team-wrapper">
            <div className="members">
         ...
         {/* four */}
         <div className='team-members-div'>
        <div className={showtab === 4 ? "wrapper active-member" : "wrapper"} >
          {/* CTA Wrapper */}
          <div className="intro-wrapper">
            <div className="team-title">SOCIAL TEAM</div>
          </div>
         ...
         {/* five */}
         <div className='team-members-div'>
        <div className={showtab === 5 ? "wrapper active-member" : "wrapper"} >
          {/* CTA Wrapper */}
          <div className="intro-wrapper">
            <div className="team-title">SOCIAL TEAM</div>
          </div>
         ...
         {/* Six */}
         <div className='team-members-div'>
        <div className={showtab === 6 ? "wrapper active-member" : "wrapper"} >
          {/* CTA Wrapper */}
          <div className="intro-wrapper">
            <div className="team-title">SOCIAL TEAM</div>
          </div>
         ...
         {/* Seven */}
         <div className='team-members-div'>
        <div className={showtab === 7 ? "wrapper active-member" : "wrapper"} >
          {/* CTA Wrapper */}
          <div className="intro-wrapper">
            <div className="team-title">SOCIAL TEAM</div>
          </div>
   ...
   {/* Eight */}
   <div className='team-members-div'>
        <div className={showtab === 8 ? "wrapper active-member" : "wrapper"} >
          {/* CTA Wrapper */}
          <div className="intro-wrapper">
            <div className="team-title">SOCIAL TEAM</div>
          </div>
