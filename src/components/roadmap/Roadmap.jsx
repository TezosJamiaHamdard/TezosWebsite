...
DevOps is not a specific job title or role, but rather a set of practices and principles that can be applied across a variety of roles in software development and IT operations.</p>
                        ...
                        <div className="card-roadmap-item swiper-slide">
                            ...
                            <p className="user-profession">Cybersecurity involves protecting systems, networks, and data from digital attacks. It encompasses practices like encryption, firewalls, and intrusion detection to prevent unauthorized access, data breaches, and other cyber threats. As cyberattacks become increasingly sophisticated, cybersecurity is critical for safeguarding sensitive information and maintaining trust in digital environments across industries.</p>
                        ...
                        <div className="card-roadmap-item swiper-slide">
                            ...
                            <p className="user-profession">Front-end development focuses on creating the user interface and experience of a website or application. It involves using technologies like HTML, CSS, and JavaScript to design responsive, interactive, and visually appealing interfaces. Front-end developers bridge the gap between design and functionality, ensuring that users can seamlessly interact with the site across different devices and browsers.</p>
                        ...
                        <div className="card-roadmap-item swiper-slide">
                            ...
                            <p className="user-profession">Backend development is the backbone of web applications, managing the server, database, and application logic. It involves using languages like Python, Java, or Node.js to handle data processing, business logic, and integration with databases and APIs. Backend developers ensure that the application runs smoothly, securely, and efficiently, providing the necessary functionality to support the frontend and user experience.</p>
